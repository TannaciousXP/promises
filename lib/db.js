...
var findUserInDatabase = function(user, callback) {
  ...
  setTimeout(function() {
    ...
    // console.log('INSIDE OF FINDUSERINDATABASE, LOOKING FOR STATE: ', state);
    if (state < 0.8) {
...
var hashPassword = function(user, callback) {
  ...
  setTimeout(function() {
    ...
    var state = Math.random();
    // console.log('INSDE HASING, CHECKING STATE: ', state);
    if (state < 0.8) {
...
var createAndSaveUser = function(user, callback) {
  ...
  setTimeout(function() {
    ...
    var state = Math.random();
    // console.log('INSDE CREATE AND SAVE USER: ', state);
